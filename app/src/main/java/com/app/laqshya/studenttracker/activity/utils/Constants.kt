...
interface Constants {
    companion object {
        ...
        const val Faculty_FCM_URL = "http://192.168.0.125/student_tracker/register_faculty_fcm_id.php"
        const val Student_FCM_URL = "http://192.168.0.125/student_tracker/register_fcm_id.php"
        const val CounsellororAdminFCMURL = "http://192.168.0.125/student_tracker/register_management_fcm_id.php"
