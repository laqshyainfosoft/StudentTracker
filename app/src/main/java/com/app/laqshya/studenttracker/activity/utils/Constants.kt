...
interface Constants {
    companion object {
        ...
        const val Faculty_FCM_URL = "http://192.168.0.113/edutracker/register_faculty_fcm_id.php"
        const val Student_FCM_URL = "http://192.168.0.113/edutracker/register_fcm_id.php"
        const val CounsellororAdminFCMURL = "http://192.168.0.113/edutracker/register_management_fcm_id.php"
